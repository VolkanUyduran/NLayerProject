   ...
   public class ProductSeed:IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 5, Name = "Orta Boy Defter", Price = 60.50m, Stock = 150, CategoryId = _ids[1] },
                new Product { Id = 6, Name = "Büyük Boy Defter", Price = 70.50m, Stock = 50, CategoryId = _ids[1] }
                );
        }
    }
}
